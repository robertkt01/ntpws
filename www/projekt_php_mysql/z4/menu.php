<?php 
	...
	<ul>
		...
		<li><a href="index.php?menu=13">Random duck</a></li>';
	if (!isset($_SESSION['user_id'])):
		print '<li><a href="?menu=6">Registracija</a></li>
			<li><a href="?menu=7">Prijava</a></li>';
	elseif ($_SESSION['role'] === 'administrator' || $_SESSION['role'] === 'editor' || $_SESSION['role'] == 'user'):
		print '<li><a href="?menu=8">Administracija</a></li>
			<li><a href="logout.php">Odjava</a></li>';
	else:
		print '<li><a href="logout.php">Odjava</a></li>';
	endif;
		print '</ul>';
?>
